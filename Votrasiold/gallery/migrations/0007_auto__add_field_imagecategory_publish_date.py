...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gallery_imagecategory', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 27, 4, 59, 6, 721757)), keep_default=False)
    ...
    models = {
        ...
        'gallery.imagecategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 27, 4, 59, 6, 721757)'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'})
        }
    }
